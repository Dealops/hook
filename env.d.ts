/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareEnv env.d.ts` (hash: a9cbe512440ba760af08de16386260e3)
// Runtime types generated with workerd@1.20260508.1 2025-10-08 global_fetch_strictly_public,nodejs_compat
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./worker");
		durableNamespaces: "WebhookSession";
	}
	interface Env {
		ASSETS: Fetcher;
		WEBHOOK_SESSION: DurableObjectNamespace<import("./worker").WebhookSession>;
	}
}
